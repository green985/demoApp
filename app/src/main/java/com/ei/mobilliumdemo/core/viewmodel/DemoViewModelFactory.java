package com.ei.mobilliumdemo.core.viewmodel;
...
/**
 * A {@link ViewModelProvider.Factory} that is injected onto each {@link ViewModel} by {@link DemoViewModelFactory}.
 */
@Singleton
public class DemoViewModelFactory implements ViewModelProvider.Factory {
    ...
    @Inject
    DemoViewModelFactory(Map<Class<? extends ViewModel>, Provider<ViewModel>> creators) {
